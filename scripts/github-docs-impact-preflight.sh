...
for required in github/scripts/github_intake_docs_review_runtime.py github/scripts/github_intake_docs_impact.py github/agents/docs-impact-reviewer/prompt.template.md github/agents/docs-journey/prompt.template.md; do
